                       ...
                       <td class="td2"><?php echo $fetch[1]; ?></td>
                        <td class="td3"><?php echo $fetch[2]; ?></td>
                         <td class="td4"><?php echo $fetch[3];?></td>
                          <td class="td5">
         <a href="editauthor.php?authid=<?php echo $fetch[0];  ?>"><button class="btn"><i class="fa fa-edit "></i> Edit</button> 
<a href="manageauthor.php?del=<?php echo $fetch[0];?>" onclick="return confirm('Are you sure you want to delete?');" >  <button class="btn1"><i class="fas fa-pencil-alt"></i> Delete</button>
                          </td>
